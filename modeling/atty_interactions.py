...
def make_atty_interactions_df(train_file_path):
    '''
    Purpose:
        Takes as input the file path for the train.csv data,
        and returns a new pandas dataframe with all attorney_flag_1
        interactions (plus the target vector).

    Usage:
        To fit models with attorney interactions, import this script and call
    ...
    Returns:
        atty_interactions_train: design matrix with attorney_flag_1 interactions
